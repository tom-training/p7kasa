    ...
    <nav>
      ...
      <div className={HeaderCSS.lesLiens}>
        ...
        {aprop ?(
          ...
          <StyledLink to="/p7kasa/a_propos" className={HeaderCSS.lien} surlignage={"underline"}>A propos</StyledLink>
          
        ):(
          
          <StyledLink to="/p7kasa/a_propos" className={HeaderCSS.lien} surlignage={"none"}>A propos</StyledLink>
